...
emitKeyPathComponent(IRGenModule &IGM,
  ...
  case KeyPathPatternComponent::Kind::SettableProperty: {
    ...
    case KeyPathPatternComponent::ComputedPropertyId::Function: {
      ...
      if (IGM.getOptions().IndirectRelativeFunctionPointer && !idRef.isIndirect()) {
        // Force the function pointer to be indirect for harvard architecture
        // even though it can be referenceable directly.
        idValue = IGM.getAddrOfIndirectFunctionPointer(IGM.getAddrOfSILFunction(id.getFunction(), NotForDefinition));
